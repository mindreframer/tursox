defmodule Tursox.MultiprocessProbe do
  @timeout_ms 30_000
  ...
  def run(_args) do
    IO.puts(:stderr, "invalid multiprocess probe arguments")
    System.halt(64)
  end
...
Tursox.MultiprocessProbe.run(System.argv())
