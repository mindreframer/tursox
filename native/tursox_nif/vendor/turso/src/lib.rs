...
impl Builder {
    ...
    /// Exposes the 0.7.2 SDK's existing `autovacuum` experimental feature.
    /// This method is missing from the published top-level Builder even though
    /// `turso_sdk_kit::rsapi::DatabaseOpts` accepts the same feature string.
